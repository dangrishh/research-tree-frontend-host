...
const App = () => {
  ...
  useEffect(() => {
    const fetchSpecializations = async () => {
      try {
        const response = await axios.get('https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/specializations');
  ...
  useEffect(() => {
    const fetchAllUsers = async () => {
      try {
        const response = await axios.get("https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/advicer-users");
  ...
  const handleEditUser = async (values) => {
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/advicer-users/${currentUser._id}`, formData, {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/users/${currentUser._id}/reset-password`, {
        newPassword,
      });
  ...
  const handleDeleteUser = async (userId) => {
    try {
      await axios.delete(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/users/${userId}`);
