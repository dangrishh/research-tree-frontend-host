...
export const Cards = () => {
  ...
  useEffect(() => {
    ...
    const fetchTotalAllUsers = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/students/Panelist" // Correct endpoint
        );
    ...
    const fetchTotalCouses = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/students/courses" // Correct endpoint
        );
    ...
    const fetchStudentPanelistsCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/students/AllPanelist" // Correct endpoint
        );
    ...
    const fetchStudentNoAdvicerCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/students/without-advisors" // Correct endpoint
        );
    ...
    const fetchAcceptedStudentAdvicerCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/advisors/accepted-students-count" // Correct endpoint
        );
    ...
    const fetchNoStatusData = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/manuscripts/noStatusManuscript/count" // Correct endpoint
        );
    ...
    const fetchDefenseData = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/manuscripts/readyToDefense/count" // Correct endpoint
        );
    ...
    const fetchReviseOnAdvicerCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/manuscripts/reviseOnAdvicer/count"
    ...
    const fetchReviseOnPanelCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/manuscripts/reviseOnPanel/count"
        ); // Adjust endpoint URL as needed
    ...
    const fetchApprovedOnPanelCount = async () => {
      try {
        const response = await axios.get(
          "https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/manuscripts/approvedOnPanel/count"
        ); // Adjust endpoint URL as needed
