...
const Sidebar = ({ onSelect }) => {
  ...
  const fetchSpecializations = async () => {
    try {
      const response = await axios.get('https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/specializations');
  ...
  const handleAddSpecialization = async () => {
    try {
      const response = await axios.post('https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/specializations', { name: newSpecialization });
  ...
  const handleEditSpecialization = async () => {
    try {
      const response = await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/specializations/${editingId}`, { name: editingName });
  ...
  const handleDeleteSpecialization = async (id) => {
    try {
      await axios.delete(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/specializations/${id}`);
  ...
  return (
    <div className='sidebar z-1 h-screen w-[313px] bg-[#1E1E1E] text-white flex flex-col fixed'>
      ...
      {admin.profileImage && <p><img className="w-32 h-32 rounded-full" src={`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com${admin.profileImage}`} alt="Profile" /></p>}
