...
const saveProfileChanges = async () => {
  ...
  try {
    const { data } = await axios.put(
      `https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/admin-user/${admin.id}`, 
      formData
    );
  ...
  const handleResetPassword = async () => {
    try {
      await axios.put(
        `https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/admin-user/${admin.id}/reset-password`,
        { newPassword }
      );
