...
export default function AccountMenu() {
  ...
  const saveProfileChanges = async () => {
    ...
    try {
      const { data } = await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/advicer-user/${user._id}`, formData);
  ...
  const handleResetPassword = async () => {
    try {
      await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/advicer-user/${user._id}/reset-password`, {
        newPassword
      });
        ...
        <Tooltip title='Account settings'>
          ...
          >
            {user && user.profileImage ? (
              <Avatar
                src={`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/public/uploads/${user.profileImage}`}
