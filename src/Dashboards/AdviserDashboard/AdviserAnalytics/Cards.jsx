...
export const Cards = () => {
  ...
  useEffect(() => {
    const fetchPdfCount = async () => {
      try {
        const response = await axios.get('https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/admin/pdfdetails/count');
    ...
    const fetchProposalStudentCounts = async () => {
      try {
          const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/advisor-students/${user._id}`);
    ...
    const fetchPanelistStudentCount = async () => {
      try {
        const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/panelist-accepted-count`);
    ...
    const fetchStudentCounts = async () => {
        try {
            const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/course-count`);
    ...
    const fetchNewUploadCount = async () => {
        try {
          const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/newUploads-count`);
    ...
    const fetchReviseOnAdvicerCount = async () => {
        try {
          const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/reviseOnAdvicer-count`);
    ...
    try {
        const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/readyToDefense-count`);
    ...
    try {
        const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/approvedOnAdvicer-count`);
    ...
    try {
        const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/reivseOnAdvicer-count`);
    ...
    try {
        const response = await axios.get(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com/api/advicer/${user._id}/approvedOnPanel-count`);
