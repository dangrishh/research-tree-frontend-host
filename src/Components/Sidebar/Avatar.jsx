...
export default function AccountMenu() {
  ...
  const saveProfileChanges = async () => {
    ...
    try {
      const { data } = await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com
/api/student/student-user/${user._id}`, formData);
  ...
  const handleResetPassword = async () => {
    try {
      await axios.put(`https://researchtree-backend-heroku-1f677bc802ae.herokuapp.com
/api/student/student-user/${user._id}/reset-password`, {
        newPassword
      });
